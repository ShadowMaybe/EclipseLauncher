...
import me.shadow.eclipselauncher.modloaders.FabricVersion;
import me.shadow.eclipselauncher.modloaders.ModloaderDownloadListener;
import me.shadow.eclipselauncher.modloaders.ModloaderListenerProxy;
import me.shadow.eclipselauncher.modloaders.modpacks.SelfReferencingFuture;
...
public abstract class FabriclikeInstallFragment extends Fragment implements ModloaderDownloadListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void onClickStart(View v) {
        ...
        mStartButton.setEnabled(false);
        EclipseApplication.sExecutorService.execute(this::performInstallation);
    }
    ...
    private void updateLoaderVersions() {
        startLoading();
        mLoaderVersionFuture = new SelfReferencingFuture(new LoadLoaderVersionsTask()).startOnExecutor(EclipseApplication.sExecutorService);
    }
    ...
    private void updateGameVersions() {
        startLoading();
        mGameVersionFuture = new SelfReferencingFuture(new LoadGameVersionsTask()).startOnExecutor(EclipseApplication.sExecutorService);
    }
