...
import me.shadow.eclipselauncher.lifecycle.ContextAwareDoneListener;
import me.shadow.eclipselauncher.lifecycle.ContextExecutor;
import me.shadow.eclipselauncher.modloaders.modpacks.imagecache.IconCacheJanitor;
...
import me.shadow.eclipselauncher.services.ProgressServiceKeeper;
import me.shadow.eclipselauncher.tasks.MoJsonExtras;
import me.shadow.eclipselauncher.tasks.AsyncVersionList;
import me.shadow.eclipselauncher.tasks.MoJsonDownloader;
...
public class LauncherActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eclipse_launcher);
        ...
        if(LauncherPreferences.PREF_MIGRATION_NOTICE)
            EclipseApplication.sExecutorService.submit(this::checkPreviousInstalls);
    ...
    private void checkPreviousInstalls(){
        final String[] packages = {"me.shadow.eclipselauncher", "me.shadow.eclipselauncher.debug"};
