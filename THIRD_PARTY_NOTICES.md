...
Eclipse Launcher is licensed under the Apache License, Version 2.0. This file records direct third-party build and runtime dependencies used by the Phase 1 application. It is not a substitute for reviewing each dependency's complete license text or for generating the final transitive software bill of materials.
