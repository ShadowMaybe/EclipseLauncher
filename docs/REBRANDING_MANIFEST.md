...
- **Checked:** directly verified in the read-only legacy reference; absent from the initially empty target.
...
| No explicit test/lint CI job | CI gap | Replace | CI now runs unit tests, lint, and debug assembly in GitHub Actions without publishing workflow artifacts | `/root/Project/EclipseLauncher/.github/workflows/ci.yml` | Checked — run 36036686843 passed |
