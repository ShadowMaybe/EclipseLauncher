...
import me.shadow.eclipselauncher.prefs.*;
...
public class JREUtils {
    ...
    public static void setupFfmpegEnv(Context ctx, Map<String, String> envMap) {
        ...
        envMap.put("ECLIPSE_FFMPEG_PATH", ffmpeg.resolveAbsolutePath("libffmpeg.so"));
    }
    public static void setGameEnvironment(Context context) throws Throwable {
        ...
        if(LauncherPreferences.PREF_BIG_CORE_AFFINITY) envMap.put("ECLIPSE_BIG_CORE_AFFINITY", "1");
